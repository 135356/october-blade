...
namespace Longbang\Blade\Controllers\Languages;

use Illuminate\Support\Facades\Input;
use Illuminate\Support\Facades\Validator;
use Longbang\Blade\Classes\CsvClasses;
use Longbang\Blade\Api\CCLanguages as CCSHOP;
use Longbang\Blade\Controllers\CommonController;
...
class IndexController extends CommonController
{
    ...
    public function index()
    {
        ...
        $language_iso3166 = $iso3166->getAll();
