...
namespace Longbang\Blade\Api;

use Illuminate\Support\Facades\DB;
use Longbang\Blade\Classes\VcPathClasses;
use Longbang\cms\Models\ConfigMultilanguage;
use Longbang\Blade\Classes\CommonClasses;
...
class CCLanguages extends CommonClasses
{
    ...
    {
        $ConfigMultilanguage = new ConfigMultilanguage();
