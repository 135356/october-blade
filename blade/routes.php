<?php include_once(__DIR__.'/config.php');define('VC_NAME',\Longbang\Blade\Classes\VcPathClasses::obj()->DIR);

use Longbang\Blade\Controllers\LanguageController;

//实际对应如：http://aaa.a/Pv4QZMrjaswXxkCG/blade/aaa
Route::get(route_route('aaa'), 'Longbang\Blade\Controllers\Languages\IndexController@aaa');
Route::get('file', function(){});

/*多语言相关（后台视图功能）*/
Route::group(['prefix'=>route_route('languages'),'namespace'=>namespace_route('languages'),'middleware'=>['\Illuminate\Cookie\Middleware\EncryptCookies::class','Longbang\Blade\Middleware\BackendSignIn::class']],function(){
